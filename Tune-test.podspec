Pod::Spec.new do |s|
  ...
  s.ios.preserve_paths        = "iOS/Tune.framework"
  s.ios.vendored_frameworks   = "iOS/Tune.framework"
  s.tvos.deployment_target    = "9.0"
  s.tvos.frameworks           = "AdSupport", "MobileCoreServices", "StoreKit", "SystemConfiguration", "UIKit"
  s.tvos.preserve_paths       = "tvOS/Tune.framework"
  s.tvos.vendored_frameworks  = "tvOS/Tune.framework"
  s.library                   = "z"
  s.requires_arc              = true
